...
number = Label(frame_back, text='Mobile Number', font=('times new roman', 14), bg='white', fg='black').place(x=40,
                                                                                                                y=300)
textbox3 = Entry(frame_back, font=('times new roman', 25)).place(x=40, y=330)
address = Label(frame_back, text='Pickup Address', font=('times new roman', 14), bg='white', fg='black').place(x=420,
                                                                                                                y=120)
textbox3 = Entry(frame_back, font=('times new roman', 25)).place(x=420, y=150)
...
conformation = tk.Button(frame_back, text='Confirmation',
